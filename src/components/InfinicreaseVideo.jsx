...
const InfinicreaseVideo = () => {
  ...
  return (
    <div className=" relative py-12 sm:py-16 md:py-24 lg:pt-[169px] lg:pb-[128px]">
      ...
      <div className="container xl:max-w-[1140px] mx-auto px-3 xl:px-0 relative z-50">
        <h2 className=" font-Nunito font-black leading-[110%] xl:text-5xl sm:text-[45px] text-3xl text-white text-center">
