...
import { Token } from "./common/Icons";
import Image from "next/image";

const Tokenomics = () => {
  return (
    <div className="container xl:max-w-[1140px] xl:px-0 px-3 mx-auto pb-[63px]">
      <p className=" font-Nunito font-black linear_color leading-[110%] xl:text-5xl sm:text-[45px] text-3xl text-center mb-10 pb-10">
        Tokenomics
      </p>
      <div className="flex flex-wrap justify-center lg:justify-between">
        <div className="xl:w-6/12 lg:w-7/12 md:w-9/12 w-full">
          <div className="border border-gainsBoro rounded-full py-[135px] px-[120px] bg-tokenShadow bg-no-repeat bg-center relative xl:scale-100 ms:scale-90 scale-75 max-[555px]:hidden">
            ...
            <div className=" max-w-[123px] absolute top-[10%] start-0 z-10 flex flex-col items-center justify-center">
              <div className=" min-w-[64px] min-h-[64px] max-w-[64px] max-h-[64px] bg_100 bg-tokenIcon bg-no-repeat bg-center flex items-center justify-center mb-1">
                <p className=" font-Nunito font-bold text-lg text-white ">1%</p>
              </div>
            ...
            <div className=" max-w-[123px] absolute top-[-3%] start-[24%] z-10 flex flex-col items-center justify-center">
              <div className=" min-w-[64px] min-h-[64px] max-w-[64px] max-h-[64px] bg_100 bg-tokenIcon bg-no-repeat bg-center flex items-center justify-center mb-1">
                <p className=" font-Nunito font-bold text-lg text-white ">4%</p>
              </div>
              <p className=" text-white font-Nunito font-semibold text-base text-center">
                Marketing
              </p>
            ...
            <div className=" max-w-[123px] absolute top-[38%] start-[-11%] z-10 flex flex-col items-center justify-center">
              <div className=" min-w-[64px] min-h-[64px] max-w-[64px] max-h-[64px] bg_100 bg-tokenIcon bg-no-repeat bg-center flex items-center justify-center mb-1">
                <p className=" font-Nunito font-bold text-lg text-white ">5%</p>
              </div>
              <p className=" text-white font-Nunito font-semibold text-base text-center">
                Initial Whale Wallet liquidity
              </p>
          ...
          <Image
            ...
            width={555}
            height={555}
            className=" w-full hidden max-[555px]:block"
          />
        </div>
        <div className=" lg:w-5/12 w-full">
          ...
          <p className=" font-Montserrat font-normal text-base text-purpleBlue mb-3 lg:pe-3">
            Infinicrease is a coin that has a bot function where when users buy
            6% is deducted from buys sells and transfers and stored in a whale
            wallet. When sell pressure occurs the equalizer is a bot that uses
            the whale wallet to buy back into the coin to stabilize the price.
            Users who have a select amount of coins are able to get access to
            the genie, the genie gives the first person who accesses it all the
            coins in the wallet at the time. (5% goes to whale wallet 1% goes to
            genie)
          </p>
          ...
          <p className=" font-Montserrat font-normal text-base text-purpleBlue">
            The whale wallet will be a smart contract wallet, and the equalizer
            will be a bot run on a custom-built infura-like service for Aptos
            into Binance Smart Chain. INF will be listed on all the major
            decentralised exchanges on Binance Smart Chain. The bot will be
            tracking prices across those decentralised exchanges and when a sell
            order happens the bot buys the coin equivalent to $88. Also when
            triggered by the developers (us) the equalizer enters PUMP mode
            which means 44% of the wallet holdings are bought back into the
            coin.
          </p>
        </div>
      </div>
